...
@implementation XFPObjcTypeEncoding
...
{
    NSDictionary * dic = [XFPObjcTypeEncoding encodings];
...
+(NSString*)of:(NSString*)typeName
{
    ...
    NSDictionary * encodings = [XFPObjcTypeEncoding encodings];
    ...
    {
        encoding = [XFPObjcTypeEncoding parseStruct:typeName];
    }
    else if ([typeName isMatch:RX(@"\\[")] && [typeName isMatch:RX(@"\\]")] )
    {
        // parse_array
        encoding = [XFPObjcTypeEncoding parseCArray:typeName];
    }
...
+(NSString*)parseCArray:(NSString*)s
{
    ...
    NSString * typeEncoding = [XFPObjcTypeEncoding of:grpType.value];
...
//            target = [target stringByAppendingString:grpStar.value];
        ...
        NSString * extractedType = [XFPObjcTypeEncoding extractType:match.value];
        NSString * encoding = [XFPObjcTypeEncoding of:extractedType];
