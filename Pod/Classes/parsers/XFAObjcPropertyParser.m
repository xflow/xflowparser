...
@implementation XFAObjcPropertyParser

-(XFAObjcProperty *) parseProperty:(NSString*)str
{
    XFAObjcProperty * property = XFAObjcProperty.new;
    ...
    property.isNSObject = [XFAObjcTypeEncoding isObjcType:property.objcType];
